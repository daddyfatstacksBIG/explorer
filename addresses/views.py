...
from blockexplorer.settings import (
...
from addresses.forms import (
    ...
    AddressSearchForm,
    KnownUserAddressForwardingForm,
...
def user_unsubscribe_address(request, address_subscription_id):
    ...
    if address_subscription.unsubscribed_at:
        ...
        msg = _(
            'You have been unsubscribed from notifications on <a href="%(address_uri)s">%(b58_address)s</a>'
            % {
