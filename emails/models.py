...
class SentEmail(models.Model):
    ...
    unsub_code = models.CharField(
        max_length=64, blank=False, null=False, unique=True, db_index=True
    )
    ...
    auth_user = models.ForeignKey(
        "users.AuthUser", null=True, blank=True, on_delete=models.CASCADE
    )
    ...
    address_forwarding = models.ForeignKey(
        "addresses.AddressForwarding", null=True, blank=True, on_delete=models.CASCADE
    )
