...
class SentEmail(models.Model):
    ...
    from_name = models.CharField(max_length=256,
                                 ...
                                 blank=True,
                                 db_index=True)
    to_email = models.EmailField(max_length=256,
                                 null=False,
                                 blank=False,
                                 db_index=True)
    to_name = models.CharField(max_length=256,
                               ...
                               blank=True,
                               db_index=True)
    cc_email = models.EmailField(max_length=256,
                                 null=True,
                                 blank=True,
                                 db_index=True)
    ...
    unsub_code = models.CharField(max_length=64,
                                  blank=False,
                                  null=False,
                                  unique=True,
                                  db_index=True)
    unsubscribed_at = models.DateTimeField(null=True,
                                           blank=True,
                                           db_index=True)
    unsub_ip = models.GenericIPAddressField(null=True,
                                            blank=True,
                                            db_index=True)
    unsub_ua = models.CharField(max_length=1024, blank=True, db_index=True)
    verif_code = models.CharField(max_length=64,
                                  blank=True,
                                  null=True,
                                  unique=True,
                                  db_index=True)
    verified_at = models.DateTimeField(null=True, blank=True, db_index=True)
    verif_ip = models.GenericIPAddressField(null=True,
                                            blank=True,
                                            db_index=True)
    ...
    address_subscription = models.ForeignKey("addresses.AddressSubscription",
                                             ...
                                             blank=True,
                                             on_delete=models.CASCADE)
    transaction_event = models.ForeignKey(
        "transactions.OnChainTransaction",
        null=True,
        blank=True,
        on_delete=models.CASCADE,
    )
    address_forwarding = models.ForeignKey("addresses.AddressForwarding",
                                           null=True,
                                           blank=True,
                                           on_delete=models.CASCADE)
